...
function add_place(placeId, placeSouthWest, placeNorthEast , placeName, placeAddr){
	/*alert(placeSouthWest));
	 ...
	 alert(placeAddr);*/
	 $("#placeId").val(placeId);
	 $("#laceSouthWest").val(placeSouthWest);
...
<form id = "formplace" name="formplace" method="post" action="${pageContext.request.contextPath}/guideMap">
	<input type="hidden" name="placeId" id="placeId" value="">
	<input type="hidden" name="laceSouthWest" id="laceSouthWest" value="">
