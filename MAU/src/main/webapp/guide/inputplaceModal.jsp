...
<body>
	<!-- 장소등록 1차 시작-->
	<div class="modal fade" id="modal-group-1" tabindex="-1"
			...
			<div class="modal-content">
				...
				<div class="modal-body text-center">
					<div class="place_name"
						style="font-size: large; color: #F3B922; font-weight: bold;">
						<h2>여기</h2>
					</div>
					<div>
						<%
						...
						%>에<br>선택한 장소를 저장하시겠습니까?
					</div>
					<div>
						<br>🔥<br>이전에 등록한 장소가 있다면<br>새로 등록한 장소로 변경됩니다.<br>
						<br>📣해당 장소는 공유됩니다.<br>개인 가이드 지도는 장소 삭제가 가능합니다.<br>함께
						만드는 가이드 지도는 장소 삭제가 불가합니다.<br>🔔주제에 맞지 않을 시 관리자가 임의 삭제할 수
						있습니다.<br>
						<br>
					</div>
				</div>
				<div class="modal-footer">
					...
					<div
						onclick="add_place(placeId, placeSouthWest, placeNorthEast , placeName, placeAddr)"
						class="add-place-btn btn btn-primary">
						<span>장소저장</span>
					</div>
				</div>
			</div>
	...
	<!--장소등록 1차 끝-->
	<!-- 장소등록 2차 시작-->
	<div class="modal fade" id="modal-group-2" tabindex="-1"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
							...
							$('input:radio[name="emoji"]')
									.click(
											function() {
												...
												var emoji_value = $(
														'input:radio[name=emoji]:checked')
														.val();
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						onclick="add_review();">리뷰 남기기</button>
				</div>
			</div>
		</div>
	</div>
