                         ...
                         <!-- 댓글달기 -->
                            <div id="inputbox" style="display: none;">
                               <form method="post" name="frm">
                                   <textarea id="modalReview" class="shadow bg-white" name="modalReview" rows="4" cols="50" placeholder="여기에 의견을 입력해주세요." style="margin-top:30px"></textarea>
                                   <input type="hidden" id="modalPlaceState" name="modalPlaceState" value="">
