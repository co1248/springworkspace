...
#placesList .item h4, #placesList .item .info {
    ...
    -->
		...
		<script>
			...
			function getListItem(index, places) {
				...
				if (places.road_address_name) { //도로명주소일때
					itemStr += '<span class="add text-dark">'
							+ places.road_address_name + '</span>'
					itemStr += '<br><div onclick="select_place('
							+ places.id
							+ ',\''
							+ places.place_name
							+ '\',\''
			...
			function add_place(placeId, placeSouthWest, placeNorthEast,
					placeName, placeAddr) {
		...
		<form id="formplace" name="formplace" method="post" action="${pageContext.request.contextPath}/guideMap/${mapSeq}">
			...
			<form id="formplace" name="formplace" method="post" action="${pageContext.request.contextPath}/guiderMap/${mapSeq}">
				...
				%>
				<input type="hidden" name="placeId" id="placeId" value=""> <input type="hidden" name="placeSouthWest" id="placeSouthWest" value=""> <input type="hidden" name="placeNorthEast" id="placeNorthEast" value=""> <input type="hidden" name="placeName" id="placeName" value=""> <input type="hidden" name="placeAddr" id="placeAddr" value=""> <input type="hidden" name="modalReview2" id="modalReview2" value=""> <input type="hidden" name="modalPlaceState2" id="modalPlaceState2" value="">
			</form>
</body>
</html>
