<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <img src="https://visualpharm.com/assets/198/Location-595b40b85ba036ed117da637.svg" class="card-img-top" width="50px"  height="50px" alt="...">추천 가이더지도
	</h1><br></div>
    ...
    <c:forEach items="${favoriteMap}" var="favoriteMap" begin="0" end="8" step="1">
	    ...
	    <div class="card border-info h-100 text-center">
	      ...
	      <div class="card-body">
	        <h5 class="card-title">${favoriteMap.mapName}</h5>
