<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <img src="https://visualpharm.com/assets/198/Location-595b40b85ba036ed117da637.svg" class="card-img-top" width="50px"  height="50px" alt="...">최신 가이드지도
	</h1><br></div>
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
    <c:forEach items="${newestMap}" var="newestMap" begin="0" end="8" step="1">
	    <div class="col" onclick="location.href='guiderMap/'+${newestMap.mapSeq}">
	    <div class="card border-info h-100 text-center">
	      ...
	      <div class="card-body">
	        <h5 class="card-title">${newestMap.mapName}</h5>
